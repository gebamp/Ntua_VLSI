...
xelab -m64 --debug typical --relax -L xil_defaultlib -L secureip --snapshot decoder_dec_behav_tb_behav --prj C:/Users/Superminiala/Documents/VLSI/Lab_1/A_2/A_2.sim/sim_1/behav/decoder_dec_behav_tb.prj   xil_defaultlib.decoder_dec_behav_tb
if errorlevel 1 (
